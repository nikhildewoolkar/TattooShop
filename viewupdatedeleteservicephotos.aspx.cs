...
public partial class viewsub : System.Web.UI.Page
{
    ...
    protected void ImageData()
    {
        ...
        con.Open();
        da = new SqlDataAdapter("select * from servicephotos", con);
        ds = new DataSet();
        da.Fill(ds);
    ...
    protected void gvImage_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox servicename = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtservicename");
        ...
        con = new SqlConnection(connStr);
        string path = "~/Images/servicephotos/";
        ...
        SqlCommand cmd = new SqlCommand("update servicephotos set servicename='"+servicename.Text+"',product_name='" + name.Text + "',product_imgurl='" + path + "',product_price='"+price.Text+"' where product_id=" + imageId + "", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void gvImage_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con = new SqlConnection(connStr);
        con.Open();
        SqlCommand cmd = new SqlCommand("delete FROM servicephotos where product_id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
